...
// Function to decreasekey dist value of a given vertex v.
...
int dijkstra(struct Graph* graph, int src, int des){
	...
	while (!isEmpty(minHeap)){
		...
		while (pCrawl != NULL){
			...
			// and distance to v through u is less than
	...
	// printArr(dist, V);
	// i moditied this part to return the distance to destination from source
	return dist[des];
}
